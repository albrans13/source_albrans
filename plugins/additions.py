...
@Client.on_message(filters.command("البرنس$", prefixes=f".") & filters.me)
async def botattt(c, msg):
    await msg.edit(
        "[albrans](http://t.me/HH_7_T)")
...
async def crist(c, msg):
    await msg.edit(
        "[⩹━★⊷⌯•𝐒𝐎𝐔𝐑𝐂𝐄 𝐀l𝐁𝐑𝐀𝐍𝐒•⌯⊶★━⩺](https://t.me/source_albrans)\n• تفعيل ، تعطيل الترحيب \n• قبول ، رفض\n• كتم ، الغاء كتم\n• سبام + الكلمه + الرقم (سبام cr 22)\n• ايدي + ايدي بالرد\n[⩹━★⊷⌯•𝐒𝐎𝐔𝐑𝐂𝐄 𝐀l𝐁𝐑𝐀𝐍𝐒•⌯⊶★━⩺](https://t.me/source_albrans)") 
...
@Client.on_message(filters.command(["م10$", "اوامر الزخرفه$"], prefixes=f".") & filters.me)
async def tota(c, msg):
    await msg.edit(
        "[⩹━★⊷⌯•𝐒𝐎𝐔𝐑𝐂𝐄 𝐀l𝐁𝐑𝐀𝐍𝐒•⌯⊶★━⩺](https://t.me/source_albrans)\n **⎈  قائـمه اوامر الزغرفه :** \n⎈  `.المواليد ` \n⎈  `.اشهر مزغرفة` \n⎈  `.البايو` \n⎈  `.قنوات` \n⎈  `.الرموز` \n⎈  `.اسماء` \n [ΒỖŤ ŻĤŘƑÃ ãlbrãñs](http://t.me/source_albrans)\n[⩹━★⊷⌯•𝐒𝐎𝐔𝐑𝐂𝐄 𝐀l𝐁𝐑𝐀𝐍𝐒•⌯⊶★━⩺](https://t.me/source_albrans)") 
...
async def hossam12(c, msg):
    ...
    animation_chars = [
        """
[⩹━★⊷⌯•𝐒𝐎𝐔𝐑𝐂𝐄 𝐀l𝐁𝐑𝐀𝐍𝐒•⌯⊶★━⩺](https://t.me/source_albrans)
: ⦑   قائمة اوامر الالعاب المتطوره في سورس البرنس  ⦒
 ★ `.القط المجنون` 
★ `.ركل الكره`
★ `.السمك الشائك`
★ `.كرة السله`
...
async def hossam13(c, msg):
    ...
    animation_chars = [
        """
[⩹━★⊷⌯•𝐒𝐎𝐔𝐑𝐂𝐄 𝐀l𝐁𝐑𝐀𝐍𝐒•⌯⊶★━⩺](https://t.me/source_albrans)
: ⦑   قائمة اوامر الالعاب في سورس البرنس  ⦒
 ★ `.اكس او` 
